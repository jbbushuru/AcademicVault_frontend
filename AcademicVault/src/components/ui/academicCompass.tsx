    ...
    if (!hasTarget) {
        return (
            <View style={styles.container}>
                ...
                <View style={{width: 38,height: 38,borderRadius: 12,backgroundColor: '#F0F7FF',justifyContent: 'center',alignItems: 'center',}}>
                    <Compass size={20} color={"#4A90D9"}/>
                </View>
                <Text style={Typography.presets.Title}>Academic Compass</Text>
            </View>
